...
public class CheckRooms extends JFrame implements ActionListener{
	...
	CheckRooms(){
				...
				label1.setText("Please Enter Room Number");
			...
			//	label3= new JLabel();
				...
				label4.setBounds(150,310,600,30);
				label4.setHorizontalTextPosition(JLabel.CENTER);
				label4.setVerticalTextPosition(JLabel.TOP);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==button) {
			...
			try {
				...
				ResultSet q= st.executeQuery("select availability from room where Room_number=" + number );
				if(q.next()){
				availability= q.getString(1);}
			...
			label4.setText("Room "+ number + " is " + availability);
