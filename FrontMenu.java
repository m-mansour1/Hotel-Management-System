...
public class FrontMenu extends JFrame implements ActionListener{
...
//	this.add(panel);
	...
	button2= new JButton();
	button2.setBounds(140,290,300,60);
	button2.setBackground(new Color(207, 190, 107));
	button2.setText("Check Rooms Availability");
	...
	button3= new JButton();
	button3.setBounds(140,400,300,60);
	button3.setBackground(new Color(207, 190, 107));
	button3.setText("Update Reward Points ");
