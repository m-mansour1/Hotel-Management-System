...
public class SalaryCut extends JFrame implements ActionListener{
	JLabel[] labels;
	JTextField field1;
	JTextField field2;
	JButton button;
...
//delete from employees where emp_name =
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==button) {
			...
			label4.setText("Salary for employee "+name+ " has been updated");
            
			
		//	panel.add(label3);
			int salary= Integer.parseInt(field2.getText());
			...
			try {
				st = con.createStatement();
				 q="update employees set emp_salary=emp_salary- " + salary +" where emp_name= '"+name+"'";
				 st.execute(q);
